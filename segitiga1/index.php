		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/sukhoi.jpg" alt="sukhoi">
				</div>

				<form class="login100-form validate-form" action="index.php" method="post">
					<span class="login100-form-title">
						Latihan Hitung Luas Segitiga
					</span>

					<div class="wrap-input100 validate-input" data-validate = "anda belum memasukan alas">
					...
					<div class="wrap-input100 validate-input" data-validate = "anda belum memasukan tinggi">
						<input class="input100" type="test" name="tinggi" placeholder="Tinggi">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="" aria-hidden="true"></i>
						</span>
